...
public final class UserLoanHistoryResponse {
    ...
    @org.jetbrains.annotations.NotNull()
    private final java.util.List<BookHistoryResponse> books = null;
    @org.jetbrains.annotations.NotNull()
    ...
    java.util.List<BookHistoryResponse> books) {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<BookHistoryResponse> component2() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<BookHistoryResponse> getBooks() {
        return null;
    }
