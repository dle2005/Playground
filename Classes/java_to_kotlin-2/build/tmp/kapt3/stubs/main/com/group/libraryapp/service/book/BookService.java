...
public class BookService {
    ...
    public BookService(@org.jetbrains.annotations.NotNull()
                       BookRepository bookRepository, @org.jetbrains.annotations.NotNull()
    com.group.libraryapp.repository.book.BookQuerydslRepository bookQuerydslRepository, @org.jetbrains.annotations.NotNull()
                       UserRepository userRepository, @org.jetbrains.annotations.NotNull()
    ...
    @org.springframework.transaction.annotation.Transactional(readOnly = true)
    public java.util.List<BookStatResponse> getBookStatistics() {
        return null;
    }
}